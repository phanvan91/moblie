                    ...
                    <div id="product">
                        <div class="primary-box row">
                                    ...
                                    <div class="product-img-thumb" id="gallery_01">
                                        <ul class="owl-carousel" data-items="3" data-nav="true" data-dots="false" data-margin="21" data-loop="true">
                                          @foreach($image_detail as $value)
                                            <li>
                                                <a href="#" data-image="{!! asset('uploads/imagedetail/'.$value['image']) !!}" data-zoom-image="{!! asset('uploads/imagedetail/'.$value['image']) !!}">
                                                    <img id="product-zoom"  src="{!! asset('uploads/imagedetail/'.$value['image']) !!}" />
                                                </a>
                                            </li>
                                            @endforeach
                                        </ul>
                            ...
                            <div class="pb-right-column col-xs-12 col-sm-7">
                                ...
                                <div class="product-price-group">
                                    <span class="price">{!! number_format($product['pricesale'],0,',','.') !!}</span>
                                    <span class="old-price">{!! number_format($product['priceold'],0,',','.') !!}</span>
                                ...
                                <div class="form-action">
                                    <div class="button-group">
                                        <a class="btn-add-cart" href="{!! URL::route('getmuahang',[$product['id'],$product['slug']]) !!}">Add to cart</a>
                                    </div>
                                    <div class="button-group">
                                ...
                                <div id="information" class="tab-panel">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>{!! $product['dungluongodia'] !!}</td>
                                        </tr>
                                        <tr>
                                            <td>Chip Đồ Họa</td>
                                            <td>{!! $product['chipsetdohoa'] !!}</td>
                                        </tr>
                                        <tr>
                                            <td>Kích Thước Màn Hình</td>
                                            <td>{!! $product['kichthuocmanhinh'] !!}</td>
                                        </tr>
                                        <tr>
                                            <td>Độ Phân Giải</td>
                        ...
                        <div class="page-product-box">
                            ...
                            <ul class="product-list owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":4}}'>
                              @foreach($product_cungloai as $cungloai)
                                <li>
                                    <div class="product-container">
                                        <div class="left-block">
                                            <a href="#">
                                                <img class="img-responsive" alt="product" src="{!! asset('uploads/'.$cungloai['image']) !!}" />
                                            </a>
                                        ...
                                        <div class="right-block">
                                            <h5 class="product-name"><a href="#">{!! $cungloai['name'] !!}</a></h5>
                                            <div class="product-star">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                            ...
                                            <div class="content_price">
                                                <span class="price product-price">{!! number_format($cungloai['pricesale'],0,',','.') !!} VND</span>
                                                <span class="price old-price">{!! number_format($cungloai['priceold'],0,',','.') !!} </span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
